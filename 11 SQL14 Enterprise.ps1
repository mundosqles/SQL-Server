...
# Datos GR
$rgName                = "SQL2014SP1-WS2012R2"
$location              = "North Europe"

# Datos red
$vnetName              = "sql14red"
$vnetPrefix            = "10.0.14.0/16"
$subnetName            = "sql14subred"
$subnetPrefix          = "10.0.14.0/24"

# Datos almacenamiento
$stdStorageAccountName = "sql14alma"
...
$osDiskName            = "osdisk"
$nicName               = "sql14nic"
$privateIPAddress      = "10.0.14.14"
$pipName               = "sql14ip"
$dnsName               = "sql14dns"
          
Write-Host("Desplegando Grupo de Recursos ... SQL2014SP1DW-WS2012R2") 
...
$nsg = New-AzureRmNetworkSecurityGroup -Name sql14w12seg -ResourceGroupName $rgName -Location $location -SecurityRules $regla3389
...
Write-Host("Grupo de Recursos SQL2014SP1DW-WS2012R2 .... Listo") 
