...
# Datos GR
$rgName                = "SQL2012SP3-WS2012R2"
$location              = "North Europe"

# Datos red
$vnetName              = "sql12red"
$vnetPrefix            = "10.0.12.0/16"
$subnetName            = "sql12subred"
$subnetPrefix          = "10.0.12.0/24"

# Datos almacenamiento
$stdStorageAccountName = "sql12alma"
...
$osDiskName            = "osdisk"
$nicName               = "sql12nic"
$privateIPAddress      = "10.0.12.12"
$pipName               = "sql12ip"
$dnsName               = "sql12dns"
          
Write-Host("Desplegando Grupo de Recursos ... sql12") 
...
$nsg = New-AzureRmNetworkSecurityGroup -Name sql12seg -ResourceGroupName $rgName -Location $location -SecurityRules $regla3389
...
$fin = get-date
Write-Host("Inicio Despliegue Proyecto_sql14w08: ",$ini) -ForegroundColor Magenta
Write-Host("Fin Despliegue Proyecto_sql14w08:    ",$fin) -ForegroundColor Magenta

Write-Host("Grupo de Recursos sql12 .... Listo") 
